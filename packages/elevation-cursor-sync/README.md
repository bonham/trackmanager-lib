...
```bash
npm install @bonham/elevation-cursor-sync
```
...
```ts
import { cursorToInterval } from "@bonham/elevation-cursor-sync";
...
import { useCursorSync, cursorToInterval } from "@bonham/elevation-cursor-sync";
